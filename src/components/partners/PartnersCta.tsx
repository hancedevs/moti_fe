...
export default function PartnersCta() {
  const cards = [
    {
      title: "Contact Us",
      desc: "Reach out to discuss partnership opportunities with MOTI Engineering.",
    ...
    {
      title: "Get Started",
      desc: "Begin your technology journey with our expert team and global partners.",
    ...
    {
      title: "Our Clients",
      desc: "See the leading organizations that trust MOTI Engineering.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AnimateInView className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            Join our network of global technology partners and help deliver
            world-class solutions across Ethiopia.
          </p>
        </AnimateInView>
