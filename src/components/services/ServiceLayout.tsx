...
function getIconForLabel(label: string, isActive: boolean): ReactNode {
  const iconClass = isActive ? "text-white" : "text-blue-400";
  ...
  return <svg className={`w-5 h-5 ${iconClass}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>;
}
    ...
    <div className="bg-[#0b0c10] min-h-screen text-white font-sans pb-20">
      ...
      <section id="solutions" className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-blue-600/10 text-blue-400 text-xs font-semibold mb-4 border border-blue-500/20">
            <span className="mr-1">#</span> Our Products
          </div>
          <h2 className="text-3xl font-bold mb-4">Choose Your <span className="text-blue-500">Category</span></h2>
        ...
        <div className="bg-[#14151a] border border-gray-800 rounded-xl p-8 mb-8 flex items-center gap-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-2">{activeItem.label}</h2>
            <p className="text-gray-400">{activeItem.description || `Complete ${activeItem.label} solutions including installation, maintenance, and monitoring.`}</p>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-gray-800 mt-12">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-[#161a23] text-gray-300 text-[11px] font-semibold mb-4 border border-gray-800">
            Why Choose Us
          </div>
          <h2 className="text-3xl font-bold text-white tracking-tight">Your Digital Transformation Partner</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <div className="bg-[#111316] border border-[#1f2937] rounded-2xl p-8 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-white text-[15px] font-bold mb-3">Proven Solutions</h3>
            <p className="text-gray-400 text-[13px] leading-relaxed">Battle-tested solutions implemented across 14+ banks</p>
          </div>
          ...
          <div className="bg-[#111316] border border-[#1f2937] rounded-2xl p-8 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-white text-[15px] font-bold mb-3">Local Support</h3>
            <p className="text-gray-400 text-[13px] leading-relaxed">In-country support team with quick response time</p>
          </div>
          ...
          <div className="bg-[#111316] border border-[#1f2937] rounded-2xl p-8 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-white text-[15px] font-bold mb-3">Expert Team</h3>
            <p className="text-gray-400 text-[13px] leading-relaxed">Certified consultants and developers</p>
          </div>
          ...
          <div className="bg-[#111316] border border-[#1f2937] rounded-2xl p-8 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-white text-[15px] font-bold mb-3">Customization</h3>
            <p className="text-gray-400 text-[13px] leading-relaxed">Tailored solutions to meet your requirements</p>
          </div>
        </div>
      </section>

      {/* CTA Section */}
      <section id="quote" className="py-20 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-gray-800 mt-12">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-gray-800 text-gray-300 text-xs font-semibold mb-6">
            Get Started
          </div>
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Get Started?</h2>
          <p className="text-gray-400 mb-10">Contact our team for product information, quotes, and customized solutions.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-[#14151a] border border-gray-800 rounded-xl p-6 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
              <div className="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center text-blue-400 mb-4">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </div>
              <h3 className="text-white font-bold mb-2">Contact Sales</h3>
              <p className="text-gray-400 text-sm mb-6 flex-grow">Get in touch with our sales team for product inquiries.</p>
            ...
            <div className="bg-[#14151a] border border-gray-800 rounded-xl p-6 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
              ...
              <h3 className="text-white font-bold mb-2">Request Quote</h3>
              <p className="text-gray-400 text-sm mb-6 flex-grow">Request pricing and customized solutions.</p>
            ...
            <div className="bg-[#14151a] border border-gray-800 rounded-xl p-6 flex flex-col items-center text-center hover:border-gray-600 transition-colors">
              ...
              <h3 className="text-white font-bold mb-2">All Products</h3>
              <p className="text-gray-400 text-sm mb-6 flex-grow">Explore our complete range of solutions.</p>
