...
const features = [
  {
    ...
    icon: <TruckIcon className="w-6 h-6 text-[#0082B4]" />,
  },
  {
    ...
    icon: <Shield01Icon className="w-6 h-6 text-[#0082B4]" />,
  },
  {
    ...
    icon: <Route01Icon className="w-6 h-6 text-[#0082B4]" />,
  },
  {
    ...
    icon: <BankIcon className="w-6 h-6 text-[#0082B4]" />,
  },
];
