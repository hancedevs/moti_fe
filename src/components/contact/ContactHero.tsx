            ...
            <div className="container mx-auto px-4 relative z-20 text-white pb-12">
                <div className="max-w-5xl">
                    ...
                    <div className="flex flex-wrap gap-6">
                        <a href="tel:+251115545059" className="flex items-center gap-2 px-4 py-2.5 transition-all">
                        ...
                        <a href="mailto:info@motiengineering.com" className="flex items-center gap-2 px-4 py-2.5 transition-all">
                            <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
