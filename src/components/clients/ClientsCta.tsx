...
export default function ClientsCta() {
  const cards = [
    {
      title: "Contact Us",
      desc: "Reach out to discuss how we can support your organization.",
    ...
    {
      title: "Our Partners",
      desc: "Explore our global technology partnerships and alliances.",
    ...
    {
      title: "Testimonials",
      desc: "Read what our clients say about working with MOTI Engineering.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AnimateInView className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Ready to <span className="text-blue-600">Partner With Us?</span>
          </h2>
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            Join Ethiopia&apos;s leading organizations who trust MOTI Engineering
