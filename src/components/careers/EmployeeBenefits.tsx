...
const benefits = [
    {
        ...
        icon: (
            <svg className="w-6 h-6 text-[#5A8CD0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const EmployeeBenefits = () => {
    return (
        <section className="bg-[#5A8CD0] py-20">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <p className="text-white/70 font-semibold mb-2 tracking-wider">WHY JOIN US</p>
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                        Employee <span className="text-white">Benefits</span>
                    </h2>
                ...
                <div className="flex flex-wrap justify-center gap-8 lg:gap-16 mb-20">
                    <div className="text-center">
                        ...
                        <p className="text-white/80 text-sm">Employee Retention Rate</p>
                    </div>
                    <div className="text-center">
                        <p className="text-5xl font-bold text-white mb-2">4.8 ★</p>
                        <p className="text-white/80 text-sm">Glassdoor Rating</p>
                    </div>
                    <div className="text-center">
                        <p className="text-5xl font-bold text-white mb-2">85%</p>
                        <p className="text-white/80 text-sm">Internal Promotion Rate</p>
                    </div>
                </div>
                ...
                <div className="text-center">
                    <Link
                        href="/contact"
                        className="inline-block bg-white text-[#5A8CD0] hover:bg-white/90 px-10 py-4 rounded-full font-bold transition-all shadow-lg"
                    >
                        Current Openings →
                    </Link>
                </div>
