        ...
        <AnimateInView className="max-w-[80rem] mx-auto" delay={0.15}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
            <div className="flex items-center gap-3">
              <div className={`flex h-8 w-8 items-center justify-center rounded ${activeTab === "Export" ? "bg-orange-100 text-orange-500" : "bg-blue-50 text-blue-600"}`}>
                {activeTab === "Export" ? (
          ...
          {activeTab === "Export" ? (
            <div className="flex flex-col gap-10">
              ...
              <div className="bg-[#fffdf0] rounded-xl border border-orange-200 p-8 shadow-sm flex flex-col md:flex-row items-center md:items-start gap-8">
                <div className="flex shrink-0 h-24 w-24 items-center justify-center rounded-2xl bg-orange-100 text-orange-500">
