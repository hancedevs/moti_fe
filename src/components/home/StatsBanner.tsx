      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-6 gap-y-6">
          {stats.map((stat, index) => (
            <AnimateInView key={index} delay={index * 0.05} y={16} className="flex flex-row items-center gap-4 px-4 relative">
              <div className="text-white opacity-90 drop-shadow-sm shrink-0">
                {stat.icon}
              </div>
