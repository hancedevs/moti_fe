        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <AnimateInView>
            ...
            <div className="space-y-8">
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-blue-100 shadow-md shadow-blue-500/5 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/15 hover:border-blue-200 transition-all duration-300">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <a href="#mission" className="inline-flex items-center text-blue-500 font-medium hover:text-blue-600 transition-colors group">
                    View Full Mission & Values
          ...
          <AnimateInView delay={0.15}>
            ...
            <h2 className="text-3xl font-extrabold text-gray-900 mb-8">Core Values</h2>
