...
export default function AboutHero() {
  return (
    <PageHero
      backgroundImage="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
      badgeIcon={badgeIcon}
      badgeLabel="About Our Company"
      headingBefore="Who"
